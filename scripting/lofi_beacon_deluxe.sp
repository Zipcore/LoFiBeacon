...
public OnPluginStart()
{
	...
	CreateConVar("lofibeacon_deluxe_version", PLUGIN_VERSION, "Lo-Fi Longwave Beacon Version", FCVAR_SPONLY|FCVAR_NOTIFY|FCVAR_PLUGIN);
	...
	c_BeaconRed = CreateConVar("lofi_beacon_red", "71", "Beacon Color: Red value (Default: 71)", FCVAR_PLUGIN);
	c_BeaconGreen = CreateConVar("lofi_beacon_green", "98", "Beacon Color: Green value (Default: 98)", FCVAR_PLUGIN);
	c_BeaconBlue = CreateConVar("lofi_beacon_blue", "145", "Beacon Color: Blue value (Default 145)", FCVAR_PLUGIN);
	c_BeaconAlpha = CreateConVar("lofi_beacon_alpha", "255", "Beacon Color: Alpha value (Default: 255)", FCVAR_PLUGIN);
	c_BeaconRadius = CreateConVar("lofi_beacon_radius", "24.0", "Set the radius of the beacon effect (Default: 24.0)", FCVAR_PLUGIN);
	c_BeaconInterval = CreateConVar("lofi_beacon_interval", "1.5", "Set interval for the beacon effect to display at (Default: 1.5)", FCVAR_PLUGIN);
